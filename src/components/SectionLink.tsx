  ...
  return (
    <Link to={path} className='block border-black/70 group'>
      <div className='flex w-full flex-col lg:flex-row lg:items-start gap-4 justify-between'>
        <div className='flex flex-col justify-between w-full hover:underline'>
          <h2 className='text-sm hover:font-bold'>
            {index !== undefined && `#${index + 1} `}{title}
          </h2>
          {images && (
            <div className='overflow-hidden'>
              <div className='flex overflow-x-auto pb-4 -mx-4 px-4 lg:mx-0 lg:px-0 transition-all duration-500 ease-in-out group-hover:gap-3'>
